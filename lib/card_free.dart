 ...
 * @Version: 2.0
 * @Autor: Lianzhidong
 * @Date: 2021-06-08 20:37:37
 * @LastEditors: Lianzhidong
 * @LastEditTime: 2021-06-08 21:49:22
 */
...
const BOOK_LIST = [
  ...
  {'title': '论中国', 'cover': '51VykQqGq9L._SY346_.jpg', 'price': '36.6'},
  {
    'title': '饥饿的盛世：乾隆时代的得与失',
    'cover': '51VykQqGq9L._SY346_.jpg',
    'price': '19.6'
  },
  {'title': '焚天之怒第四卷至大结局', 'cover': '51VykQqGq9L._SY346_.jpg', 'price': '19.6'},
  {'title': '我就是风口', 'cover': '51VykQqGq9L._SY346_.jpg', 'price': '88.8'},
  {'title': '大宋的智慧', 'cover': '51VykQqGq9L._SY346_.jpg', 'price': '22.8'},
];
    ...
    return Expanded(
      ...
      child: Column(
        children: [
          ...
          Padding(padding: EdgeInsets.only(bottom: 20), child: _bottomBottom())
        ],
      ),
    ));
  }
